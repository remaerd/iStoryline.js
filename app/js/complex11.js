...
main('Match11/Complex.json')

// Initialise json files
const jsonRead = d3Fetch.json('../../data/json/Match11/MatchInfo.json') // Info of match
const jsonReadTwo = d3Fetch.json('../../data/json/Match11/killingInfo.json') // Killing info file generated by python
